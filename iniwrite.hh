...
int ini_get_double_param(IniFile* inifile, const char* section, const char*key, double* val, double defaultVal=0);
int ini_get_string_param(IniFile* inifile, const char* section, const char*key, char* val, const char* defaultVal="");
